...
zbyte JoycePcwMouse::in(zword port)
{
	int y, x;
...
//
static int zmemcmp(zword addr, zbyte *compare, int count)
{
        int n;
...
//
static void zmemput(zword addr, zbyte *replace, int count)
{
        int n;
...
void JoycePcwMouse::checkPatch(void)
{
	Z80 *R = m_sys->m_cpu;
        ...
        static zbyte md3_match1[5] = {0xDB, 0xA2, 0xF6, 0xF8, 0xC9};
        static zbyte md3_match2[6] = {0xCD, 0x00, 0x00, 0x28, 0x0F, 0x2A};
        static zbyte md3_patch2[6] = {0x3E, 0xFD, 0xED, 0xFE, 0xA7, 0xC9};
        static zbyte sp_match[9]   = {0xED, 0x78, 0xFE, 0x10, 0x20,
                                     0x0E, 0x01, 0x80, 0x81};
        static zbyte sp_patch[7]   = {0x3E, 0xFD, 0xED, 0xFE, 0xC3, 0x00, 0x00};
        static zbyte mp_match1[7]  = {0xDB, 0xA2, 0x3C, 0x28, 0x49, 0x3D, 0x21};
        static zbyte mp_match2[14] = {0xDB, 0xD0, 0x47, 0xDB, 0xD1, 0x4F, 0xDB,
...
void JoycePcwMouse::out(zword address, zbyte value)
{
