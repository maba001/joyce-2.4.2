/************************************************************************
    ...
    Copyright (C) 1996, 2001, 2020  John Elliott <seasip.webmaster@gmail.com>
...
zbyte Z80Dart::inData()
{
	return m_latch;
}

void Z80Dart::outData(zbyte b)
{
	m_latch = b;
}

void Z80Dart::out(zbyte reg, zbyte value)
{
...
void Z80DartA::out(zbyte reg, zbyte value)
{
//
...
zbyte Z80DartA::inData()
{
	m_latch = m_comms->read();
	return Z80Dart::inData();
}

void Z80DartA::outData(zbyte b)
{
	Z80Dart::outData(b);
...
void Z80DartB::out(zbyte reg, zbyte value)
{
	zbyte strobe = m_reg[5] & 0x80;
...
void JoyceCPS::out(zbyte port, zbyte value)
{
	if (!isEnabled()) return;
	switch(port & 0x0F)
	{
