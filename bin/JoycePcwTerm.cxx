...
static zbyte        gl_screenShadow[90][256];
static int          gl_lineLen;
static zbyte        gl_shadowInvalid;
static zbyte        gl_debugMode = false;
...
void JoycePcwTerm::out(zword port, zbyte value)
{
	switch(port & 0xFF)
	{
		case 0xF5:
...
void JoycePcwTerm::border(zbyte forced)
{
        int lblk, count, n;
        SDL_Rect rects[4];
        Uint32 pixel;
...
void JoycePcwTerm::setForeground(zbyte r, zbyte g, zbyte b) 
{
        m_screenFg.r = r;
	m_screenFg.g = g;
	m_screenFg.b = b;
...
void JoycePcwTerm::setBackground(zbyte r, zbyte g, zbyte b)
{
        m_screenBg.r = r;
	m_screenBg.g = g;
	m_screenBg.b = b; 
