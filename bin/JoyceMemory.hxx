...
//       
extern zbyte *PCWRD[4];          /* Pointers to the current memory banks - reading */
extern zbyte *PCWWR[4];          /* Pointers to the current memory banks - writing */

class JoyceMemory : public PcwMemory
{
protected:
	zbyte m_bankLock[4];       /* Read & write to the same bank? */
	zbyte m_lastPage[4];
