...
void AnneKeyboard::setRange(int *R, zbyte a, zbyte b, zbyte c, zbyte d)
{
...
void AnneKeyboard::pushKey(zbyte kc)
{
...
zbyte AnneKeyboard::in(zbyte port)
{
	zbyte k = 0, b = 0;
...
void AnneKeyboard::out(zbyte port, zbyte value)
{
