...
void PcwFDC::setMotor(zbyte b)
{
	fdc_set_motor(m_fdc, b);
}


void PcwFDC::writeData(zbyte b)
{
...
void PcwFDC::writeDRR(zbyte b)
{
	fdc_write_drr(m_fdc, b);
}


zbyte PcwFDC::readDIR()
{	
//	zbyte b = fdc_read_dir(m_fdc);
//	fprintf(stderr, "DIR=%d\n", b);
	return fdc_read_dir(m_fdc);
}

zbyte PcwFDC::readData(void)
{
	return fdc_read_data(m_fdc);
}


zbyte PcwFDC::readControl(void)
{
...
bool PcwFDC::loadBootSector(const string filename, const char *type, zbyte *sector)
{
	int err;
