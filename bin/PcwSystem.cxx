...
// 0F000h. 
//
static const zbyte initBoot[] = { 0xF3, 0x31, 0x00, 0xF0, 0xC3, 0x10, 0xF0 };
...
//
void PcwSystem::zputs(zword W, const char *s)
{
        int n = 0;
...
bool PcwSystem::loadBoot(zbyte *memory, string bootfile)
{
        FILE *fp;
...
//
	...
	fseek(fp, 0, SEEK_SET);
	m_bootRom    = new zbyte[m_bootRomLen];
