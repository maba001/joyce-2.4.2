...
zbyte *PCWRD[4];          /* Pointers to the current memory banks - reading */
zbyte *PCWWR[4];          /* Pointers to the current memory banks - writing */
...
void JoyceMemory::out(zbyte port, zbyte value)
{
	int bankoff;
...
zbyte JoyceMemory::in(zbyte port)
{
	return 0xFF;
}


zbyte JoyceMemory::getPage(zbyte port)
{
