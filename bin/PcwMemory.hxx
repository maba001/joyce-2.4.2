...
*************************************************************************/
//
extern zbyte *PCWRAM;            /* The PCW's memory, all 2048k */
...
// Page the memory
//
	virtual void out(zbyte port, zbyte value) = 0;
	virtual zbyte in(zbyte port) = 0;
	virtual zbyte getPage(zbyte port) = 0;
