/*************************************************************************
    ...
    JOYCE v2.4.2 - Amstrad PCW emulator

    Copyright (C) 1996, 2001-2007,2012-14,2016-7,2020,2023 John Elliott <seasip.webmaster@gmail.com>
