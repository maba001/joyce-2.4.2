...
//
AnneSerial::AnneSerial(zbyte basePort, AnneSystem *s) : PcwDevice("serial", 
		(basePort == 0x28) ? "com1" :
...
zbyte AnneSerial::in(zbyte port)
{
...
void AnneSerial::out(zbyte port, zbyte value)
{
